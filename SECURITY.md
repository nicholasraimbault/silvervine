...
**Email:** `nraimbault16+security@gmail.com`
...
Encrypt sensitive details with GPG if you want — my GPG public key is on my GitHub profile (`https://github.com/nicholasraimbault.gpg`).

## Response SLA

- **Acknowledgment:** within **48 hours** of receipt. If you don't hear back in 48 hours, assume the email got eaten by spam filters and reply with a reminder; if still nothing in 96 hours, file a confidential GitHub security advisory at https://github.com/nicholasraimbault/silvervine/security/advisories/new.
